...
class MergeBaseIntoBranchTest(unittest.TestCase):
    ...
    The op lives in merge_recovery (leaf module) but reuses worker._git, so this stays a worker-side
    git-hygiene test."""
