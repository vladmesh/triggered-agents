...
и той же планкой durable, что и транскрипты: файл уже дистиллят одной головы, но не
твой дистиллят, сомнительное всё равно пропускаешь. Конвертация при переносе:
...
вместо session id — имя файла-источника (`curator:claude/memory/<slug>` или
`curator:hermes/memory/<slug>`).
